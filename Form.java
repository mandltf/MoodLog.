...
public class Form extends javax.swing.JFrame {
    ...
    public Form(Homepage homepage) {
        ...
        this.mood = homepage.getMood();  
        if (this.mood == null || this.mood.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please select a mood first!", "Warning", JOptionPane.WARNING_MESSAGE);
            new Homepage(username).setVisible(true);
            dispose();
            return;
        }
        
        expression.setText(this.mood);
        
        
        History historyView = homepage.getHistoryView();
        formulir = new Controller_Form(this, historyView);
        
        //warnain teks
        if(this.mood.equals("EMBARRASSED 👉👈")){
            expression.setForeground(new Color(255, 160, 122));
        }else if(this.mood.equals("SULKING 😤")){
            expression.setForeground(Color.RED);
        }else if(this.mood.equals("HAPPY 😚")){
            expression.setForeground(new Color(255, 165, 0));
        }else if(this.mood.equals("FLUSHED 🤭")){
            expression.setForeground(new Color(255, 99, 71));
        }else if(this.mood.equals("LOVELY 🥰")){
            expression.setForeground(new Color(255, 105, 180));
        }else if(this.mood.equals("SURPRISED 😱")){
   ...
   private void submitActionPerformed(java.awt.event.ActionEvent evt) {
        // Submit the mood data first
        formulir.inputEmot();
        
        // Create and show new History view
        History historyView = new History(homepage);
...
//        });
    ...
    public String getUsername(){
        System.out.println("Form getUsername returning: " + username);
        return username;
    }
    public String getMood() {
        return this.mood;  // Return the stored mood value
    }
    ...
    public void clearFields() {
        jTextField1.setText("");
        jSlider1.setValue(5); // Reset to middle value
    }
