...
public class Edit extends javax.swing.JFrame {
    ...
    public Edit(History history, String timestamp, String mood, String description, int level) {
        this.username = history.getUsername();
        this.userid = history.getUserid();
        ...
        Mood.setSelectedItem(mood);
        jTextField1.setText(description);
        jSlider1.setValue(level);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        controller.updateMood(timestamp, userid);
