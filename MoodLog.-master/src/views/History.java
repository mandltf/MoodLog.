...
public class History extends javax.swing.JFrame {
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (selectedRow != -1) {
            String timestamp = tabel.getValueAt(selectedRow, 0).toString();
            String mood = tabel.getValueAt(selectedRow, 1).toString();
            String description = tabel.getValueAt(selectedRow, 2).toString();
            int level = Integer.parseInt(tabel.getValueAt(selectedRow, 3).toString());
            
            new Edit(this, timestamp, mood, description, level).setVisible(true);
            dispose();
        } else {
